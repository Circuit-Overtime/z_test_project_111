...
import pandas as pd 
import random 
data = pd.read_csv("F:\\Python works\\Python Program 2\\WhiteHatJt\\C101 python\\C109_WHT\\maths_score.csv") 
...
def show_fig(meanList):
  ...
  fig = ff.create_distplot([figData],["Math Score"],show_hist = False) 
